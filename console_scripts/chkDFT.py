...
dft, u1, u2, scale, out_name, vmd, ovito, me = 'orca', 'Ha', 'Ha', 1.0, 'out', False, False, False
...
if dft == 'g09':
    ...
    try:
        ...
        print("Error - jdftx simulation %s does not exist. Are you sure -dft jdftx is correct?" % run_name)
        sys.exit()
else:
