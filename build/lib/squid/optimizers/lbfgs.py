...
def lbfgs(params,
    ...
    *Parameters*
        ...
        new_opt_params: *dict*
            ...
            parameters.  This includes the following -
                ...
                max_steps_remembered: *int*
                    The maximum number of previous iterations to save.
                ...
                start_hess: *int, float, or matrix*
                    A starting integer or float to scale the starting hessian.
    ...
    *Returns*
    ...
    def BFGS_multiply(s, y, grad, scale):
        '''
    ...
    while loop_counter < maxiter:
        ...
        if (start_hess is None or loop_counter > 0) and not use_numopt_start:
            start_hess = 1.0
        ...
        if debugging and start_hess != 1.0 and use_numopt_start:
            print("\tScaling by %lg" % start_hess)
        ...
        # Note, if we aren't using linesearching, we can probably do away with
        # this scaling step.  It might make it better.
        ...
        if len(stored_params) == 0:
            start_hess = np.dot(change_in_gradient, change_in_params) / np.dot(change_in_gradient, change_in_gradient)
